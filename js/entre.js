...
document.getElementById("boxlet-overview").addEventListener("click", function(){
	$('html, body').animate({
								scrollTop: $("#boxlet").offset().top-100
						}, 1500);
})

document.getElementById("memlabs-overview").addEventListener("click", function(){
	$('html, body').animate({
								scrollTop: $("#memory-labs").offset().top-100
						}, 1500);
})
